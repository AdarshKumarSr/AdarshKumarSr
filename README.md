...
- 💡 Exploring **Spring Boot** and diving into backend architecture  
- 🎨 Love crafting **polished, animated frontends**  
- 🧠 Regularly solving **DSA problems** to sharpen problem-solving skills  
- ⚙️ Working with **MERN Stack** & **Java-based projects** in parallel  
